...
class EtlApplication(object):
    ...
    def __init__(self,country_fetch_api_url,gdp_scsv_file_path,conn_string):
        self.country_fetch_api_url = country_fetch_api_url
        self.gdp_scsv_file_path = gdp_scsv_file_path
    ...
    def extract_input_data(self) -> list:
        ...
        country_data_raw_df.columns = ['country_id', 'iso2_code', 'country_name', 'capital_city', 'longitude', 'latitude', 'region_id',
                                        'region_iso2code', 'region_value', 'admin_region_id', 'admin_region_iso2code',
                                        'admin_region_value', 'income_level_id', 'income_level_iso2code',
                                        'income_level_value', 'lending_type_id', 'lending_type_iso2code',
                                        'lending_type_value'
                                       ]
        gdp_data_raw_df = csv_to_df(self.gdp_scsv_file_path)
        gdp_data_raw_df.columns = ['country_name', 'country_code', 'indicator_name', 'indicator_code', 'year_2019', 'year_2020',
                                   'year_2021', 'year_2022', 'year_2023','Unnamed'
                                   ]
    ...
    def transform_input_data(self) -> list:
        try:
            ...
            country_fact_df = country_data_raw_df[['country_id', 'region_id', 'admin_region_id', 'income_level_id', 'lending_type_id']]\
                                .drop_duplicates(['country_id', 'region_id', 'admin_region_id', 'income_level_id', 'lending_type_id'])\
                                .mask(country_data_raw_df == '')
            country_details_df = country_data_raw_df[['country_id', 'iso2_code', 'country_name', 'capital_city', 'longitude', 'latitude', 'region_id']]\
                                    .drop_duplicates(['country_id', 'iso2_code', 'country_name', 'capital_city', 'longitude', 'latitude', 'region_id'])\
                                    .mask(country_data_raw_df == '')
            country_region_df = country_data_raw_df[['region_id', 'region_iso2code', 'region_value']]\
                                    ...
                                    .mask(country_data_raw_df == '')
            country_admin_region_df = country_data_raw_df[['admin_region_id', 'admin_region_iso2code', 'admin_region_value']]\
                                        .drop_duplicates(['admin_region_id', 'admin_region_iso2code', 'admin_region_value'])\
                                        .mask(country_data_raw_df == '').dropna()
            country_income_level_df = country_data_raw_df[['income_level_id', 'income_level_iso2code', 'income_level_value']]\
                                        .drop_duplicates(['income_level_id', 'income_level_iso2code', 'income_level_value'])\
                                        .mask(country_data_raw_df == '')
            country_lending_type_df = country_data_raw_df[['lending_type_id', 'lending_type_iso2code', 'lending_type_value']]\
            ...
            print('country_raw\ncountry_gdp\ncountry_fact\ncountry_details\nregion\nadmin_region\nincome_level\nlending_type\n')
            return [country_data_raw_df.mask(country_data_raw_df == ''), gdp_cleansed_data_df.mask(gdp_cleansed_data_df == ''),
...
if __name__ == "__main__":
    ...
    postgres_conn_string=str('postgresql+psycopg2://'+args['postgres_user_name']+':'+args['postgres_password']+'@'+
