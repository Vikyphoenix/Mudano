...
with suppress_stdout():
    ...
    #test_trasnform_output= test_data.transform_input_data()


'''Expected Output test data '''
test_country_df = pandas.DataFrame({"country_id": "BRA","iso2_code": "BR","country_name": "Brazil","region_id": "LCN","region_iso2code": "ZJ","region_value": "Latin America & Caribbean (all income levels)","admin_region_id": "LAC","admin_region_iso2code": "XJ","admin_region_value": "Latin America & Caribbean (developing only)","income_level_id": "UMC", "income_level_iso2code": "XT","income_level_value": "Upper middle income","lending_type_id": "IBD","lending_type_iso2code": "XF","lending_type_value": "IBRD","capital_city": "Brasilia","longitude": "-47.9292","latitude": "-15.7801"},index=[0])
test_gdp_df = pandas.DataFrame({"country_name": "Brazil","country_code": "BRA","indicator_name": "GDP growth, constant (average 2010-19 prices and exchange rates)","indicator_code": "NYGDPMKTPKDZ","year_2019": "1.2","year_2020": "-3.9","year_2021": "4.9","year_2022": "1.4","year_2023": "2.7"},index=[1])
...
if __name__ == "__main__":
    ...
    print('------------------- Total Test cases ran : ' + str(len(test_cases_ran)) + '; Total Passed Test cases : ' + str(len(passed_test_cases)) + '; Total Failed Test cases : ' + str(len(failed_test_cases)) + ' -------------------')
    #
